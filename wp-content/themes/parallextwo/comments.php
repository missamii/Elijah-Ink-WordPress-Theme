<?php /* This comments.php file is mostly copied from TwentyTen theme, the default WordPress theme. */ ?>
<div id="comments">
<?php if ( post_password_required() ) : ?>
				<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.' ); ?></p>
			</div><!-- #comments -->
<?php
		/* Stops the rest of comments.php from being processed,
...
<?php if ( have_comments() ) : ?>
		<h3 class="w3-text-white" id="comments-title">
			<?php
